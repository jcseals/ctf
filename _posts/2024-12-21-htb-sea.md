...
tags: [htb, wondercms, xss, cwe-78, cwe-79, cve-2023-41425, command-injection, web]
...
The parameter not only triggers the monitoring system to display the root flag, but we can inject a reverse shell command via this parameter and the process will execute it, causing a root shell to be delivered back to our listener.
